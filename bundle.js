...
(function () {
    ...
    const isChatConvEvent = ({ data }) => data && data.messageType === MESSAGE_TYPE;
    ...
    const handleOnmessage = (set, reducer, store) => {
    	return (e) => {
    		const state = reducer(e, get_store_value(store));
    		if (state) set(state);
    	};
    };
    ...
    /* src/components/Nested.svelte generated by Svelte v3.24.0 */
    const file = "src/components/Nested.svelte";
    ...
    // (14:1) {#each $conversations as conv}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*conv*/ ctx[4].userName + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$conversations*/ 2 && t_value !== (t_value = /*conv*/ ctx[4].userName + "")) set_data_dev(t, t_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:1) {#each $conversations as conv}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*$conversations*/ ctx[1];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 11, 0, 307);
    			add_location(ul, file, 12, 0, 352);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span, "click", /*handleClick*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$conversations*/ 2) {
    				each_value = /*$conversations*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	let $conversations;
    	validate_store(conversations, "conversations");
    	component_subscribe($$self, conversations, $$value => $$invalidate(1, $conversations = $$value));
    	let { answer } = $$props;
    	...
    	return [answer, $conversations, handleClick];
    }
    ...
    const initEventEmmiter = (dispatchEvent) => {
    ...
    // (16:1) {#each $messages.list as msg}
    function create_each_block$1(ctx) {
    	let li;
    	let t_value = /*msg*/ ctx[3].message + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$1, 16, 2, 306);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$messages*/ 2 && t_value !== (t_value = /*msg*/ ctx[3].message + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(li);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:1) {#each $messages.list as msg}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let nested;
    	let current;
    	let each_value = /*$messages*/ ctx[1].list;
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	nested = new Nested({ props: { answer: 42 }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 11, 0, 251);
    			add_location(ul, file$1, 14, 0, 268);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$messages*/ 2) {
    				each_value = /*$messages*/ ctx[1].list;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["name", "dispatchEvent"];
    	...
    	$$self.$set = $$props => {
    		...
    		if ("dispatchEvent" in $$props) $$invalidate(2, dispatchEvent = $$props.dispatchEvent);
    	};
    	...
    	return [name, $messages, dispatchEvent];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { name: 0, dispatchEvent: 2 });
    		...
    		if (/*dispatchEvent*/ ctx[2] === undefined && !("dispatchEvent" in props)) {
    			console.warn("<App> was created without expected prop 'dispatchEvent'");
    		}
    	}
